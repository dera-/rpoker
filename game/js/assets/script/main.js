...
module.exports.main = function main(param) {
  ...
  const WORD_ASSET_IDS = ["cards", "normalWords", "specialWords0", "specialWords1", "specialWords2", "specialWords3", "specialWords4"];
